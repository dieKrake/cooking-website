  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekdays: "flex",
        weekday: "text-foreground/50 rounded-md w-9 font-normal text-[0.8rem]",
        ...
        outside:
          "day-outside text-foreground/50 aria-selected:bg-accent/50 aria-selected:text-foreground/50",
